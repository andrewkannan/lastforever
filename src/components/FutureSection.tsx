...
export default function FutureSection({ position, memories, onClickItem }: FutureProps) {
  ...
  return (
    ...
    >
      ...
      <img src="/floral-future.png" alt="floral accent" className="absolute -top-12 -left-12 w-40 h-40 object-contain mix-blend-multiply opacity-90 pointer-events-none z-10 -scale-x-100" />
      <img src="/floral-future.png" alt="floral accent" className="absolute -bottom-12 -right-12 w-40 h-40 object-contain mix-blend-multiply opacity-90 pointer-events-none rotate-180 z-10 -scale-x-100" />
