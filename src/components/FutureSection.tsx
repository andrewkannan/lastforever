...
export default function FutureSection({ position, memories, onClickItem }: FutureProps) {
  ...
  return (
    ...
    >
      ...
      <img src="/floral-future.png?v=2" alt="floral accent" className="absolute -top-12 -left-12 w-40 h-40 object-contain pointer-events-none z-10 -scale-x-100" style={{ transform: "translateZ(0)", WebkitTransform: "translateZ(0)" }} />
